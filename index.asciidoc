...
|
| Note: In addition to searching uniprot_sprot.pep, you can search any other protein database and load the results in 
|       as a custom protein database.
|       Searching Swissprot, however, is critical to Trinotate, because that's where it retrieves the various
|       Kegg, GO, and Eggnog, etc., annotations from.
|
|======================================================================================================
